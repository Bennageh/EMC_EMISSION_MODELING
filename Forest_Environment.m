...
datas = readmatrix('datas_3.xlsx'); %  551 rows, 7 columns
awgn_data=readmatrix('awgn_3.xlsx');   %  551 rows, 3 columns
...
Y_dB=10*log10(Y_abs)+R_gain_antenna+3+20*log10(300./(4*pi()*frequencies*10))-0;
%   Plot the results comparison between Received emission power and
%   statistic model of received power
figure("Name","Forest Environment")
